  ...
  theme: {
    extend: {
      colors: {
        ...
        'todo-list-scrollbar-bg': 'var(--todo-list-scrollbar-bg)',
        'todo-list-scrollbar-thumb-bg': 'var(--todo-list-scrollbar-thumb-bg)',
        'todo-list-scrollbar-thumb-bg-hover': 'var(--todo-list-scrollbar-thumb-bg-hover)',
